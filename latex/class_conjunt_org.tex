...
Definició a la línia 44 del fitxer Conjunt\-Org.\-hpp.
...
\begin{DoxyCode}
7                             \{
8   \hyperlink{class_conjunt_org_adab11e0ac8295072ec682716478a535a}{V} = vector<Organisme> (M);
9     \hyperlink{class_conjunt_org_ae566806533e21f56caf27480d342c460}{Rank} = vector<OrganRank> (M);
10     \hyperlink{class_conjunt_org_a254051054023bf3ecbbe96c82cfe46a2}{Rel} = vector< stack<ParFill> > (M);
11   \hyperlink{class_conjunt_org_a9782fdb4c89e8dd61762453de8f77fcb}{Aparellat} = vector< vector<bool> > (M, vector<bool> (M));  
12   \hyperlink{class_conjunt_org_a468e7686498561628ad731ea196df8b5}{tamany} = 0;
13 \}
\end{DoxyCode}
...
\begin{DoxyCode}
16 \{
17   \hyperlink{class_conjunt_org_adab11e0ac8295072ec682716478a535a}{V} = c.V;
18   \hyperlink{class_conjunt_org_ae566806533e21f56caf27480d342c460}{Rank} = c.Rank;
19     \hyperlink{class_conjunt_org_a254051054023bf3ecbbe96c82cfe46a2}{Rel} = c.Rel;
...
\begin{DoxyCode}
27 \{
28   \textcolor{keywordflow}{if} (\hyperlink{class_conjunt_org_a468e7686498561628ad731ea196df8b5}{tamany} == \textcolor{keywordtype}{int}(\hyperlink{class_conjunt_org_adab11e0ac8295072ec682716478a535a}{V}.size())) cout << \textcolor{stringliteral}{"ERROR 1: El conjunt esta ple"} << endl;
29   \textcolor{keywordflow}{else} \{
30     \hyperlink{class_conjunt_org_adab11e0ac8295072ec682716478a535a}{V}[\hyperlink{class_conjunt_org_a468e7686498561628ad731ea196df8b5}{tamany}] = o;
31     ++\hyperlink{class_conjunt_org_a468e7686498561628ad731ea196df8b5}{tamany};
32   \}
33 \}
\end{DoxyCode}
...
\begin{DoxyCode}
36 \{
37   \textcolor{keywordflow}{while} (not P.empty()) \{
38     \textcolor{keywordtype}{int} x = P.top();
39     \hyperlink{class_conjunt_org_adab11e0ac8295072ec682716478a535a}{V}[x - 1].estirar\_organisme();
40     P.pop();
41   \}
42 \}
\end{DoxyCode}
...
\begin{DoxyCode}
45 \{
46   \textcolor{keywordflow}{while}(not P.empty()) \{
47     \textcolor{keywordtype}{int} x = P.top();
48     \hyperlink{class_conjunt_org_adab11e0ac8295072ec682716478a535a}{V}[x - 1].retallar\_organisme();
49     P.pop();
50   \}
51 \}
\end{DoxyCode}
...
\begin{DoxyCode}
59 \{ \textcolor{keywordflow}{return} \hyperlink{class_conjunt_org_a468e7686498561628ad731ea196df8b5}{tamany}; \}
\end{DoxyCode}
...
\begin{DoxyCode}
62 \{
63   \textcolor{keywordtype}{bool} mort = \textcolor{keyword}{true};
64   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < \hyperlink{class_conjunt_org_a468e7686498561628ad731ea196df8b5}{tamany}; ++i) \textcolor{keywordflow}{if} (not \hyperlink{class_conjunt_org_adab11e0ac8295072ec682716478a535a}{V}[i].es\_mort()) mort = \textcolor{keyword}{false};
65   \textcolor{keywordflow}{return} mort;
66 \}
\end{DoxyCode}
...
\hypertarget{class_conjunt_org_a254051054023bf3ecbbe96c82cfe46a2}{\index{Conjunt\-Org@{Conjunt\-Org}!Rel@{Rel}}
