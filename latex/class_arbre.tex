...
\begin{DoxyCode}
  \{
    ...
    \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (\hyperlink{class_arbre_a62818cdde6c1912a7c9a15db3b93d297}{primer\_node}==NULL)
      \textcolor{keywordflow}{throw} \hyperlink{class_p_r_o2_excepcio}{PRO2Excepcio} (\textcolor{stringliteral}{"Un arbre buit no t� fills"});
    \textcolor{keywordflow}{else}   
      \textcolor{keywordflow}{throw} \hyperlink{class_p_r_o2_excepcio}{PRO2Excepcio} 
...
\begin{DoxyCode}
  \{
    ...
    \textcolor{keywordflow}{else}
      \textcolor{keywordflow}{throw} \hyperlink{class_p_r_o2_excepcio}{PRO2Excepcio} (\textcolor{stringliteral}{"Un arbre buit no t� arrel"});
  \}
\end{DoxyCode}
