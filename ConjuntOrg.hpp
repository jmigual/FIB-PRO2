...
public:
     ...
     *  \pre N és un nombre més petit o igual que el tamany, marca ens indica
     *  un enter que utilitzarem per indicar l'entrada de l'arbre de un
     *  organisme
     *  \post Es llegeixen els organismes inicials del conjunt
     */
    void llegir(int N, int marca);
